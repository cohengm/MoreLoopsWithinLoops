...
def largest_number(seq_seq):
    if empty(seq_seq) == None:
        return None


    max = seq_seq[empty(seq_seq)][0]
...
def run_test_largest_negative_number():
    ...
    answer = largest_negative_number(([], [-1111111111111111], [-99999999999999999999999999999999]))
    print('Expected and actual are:', expected, answer)
